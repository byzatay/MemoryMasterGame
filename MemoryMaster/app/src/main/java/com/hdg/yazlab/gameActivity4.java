...
public class gameActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        skor = (TextView) findViewById(R.id.textView2);
        ...
        countDownTimer= new CountDownTimer(46000,1000){
            ...
            public void onTick(long l){
                ...
                if(count==16){
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(gameActivity4.this);
                    alertDialogBuilder
        ...
        docReference.get()
                .addOnSuccessListener(this, new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(gameActivity4.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
    }
